...
class Moteur: 
    ...
    def __init__(self, taille, config, joueur): 
        ...
        # Si la config n'existe pas on la crée puis on la charge
    ...
    def is_food(self, position): 
        """
            retourne true si la case est de la nourriture
        """
    ...
    def is_wall(self, position):
        """
            true si le serpent est en dehors du plateau
        """
    ...
    def update_position(self, joueur): 
        ...
        if self.is_wall(position) or self.is_snake(position): 
            ...
            # Gestion de la queue du serpent
    ...
    def get_state(self, next_position_X, next_position_Y): 
        """
            retourne l'état d'une position
        """
    ...
    def evaluer(self, joueur, at): 
        """
            associer une récompense à un état donné
        """     
    ...
    def bellmann_equation(self, at, atp1, st, stp1, reward): 
        """
...
class Affichage: 
    ...
    def afficher(self, memoire, joueur): 
        """
            affiche le contenu de la mémoire du moteur de jeu à un instant donné
        """
